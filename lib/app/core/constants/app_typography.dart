...
class AppTypography {
  ...
  // Font Family - Segoe UI with Roboto fallback
  ...
  static TextStyle kpiValue({Color? color}) => GoogleFonts.roboto(
    fontSize: 24,
    fontWeight: FontWeight.w700,
    color: color,
  );
  ...
  static TextStyle kpiLabel({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: color,
  );
  ...
  static TextStyle inputLabel({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: color,
  );
  ...
  static TextStyle inputValue({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: color,
  );
  ...
  static TextStyle placeholder({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: color,
  );
  ...
  static TextStyle tableHeader({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w500,
    color: color,
  );
  ...
  static TextStyle tableCell({Color? color}) => GoogleFonts.roboto(
    fontSize: 14,
    fontWeight: FontWeight.w400,
    color: color,
  );
