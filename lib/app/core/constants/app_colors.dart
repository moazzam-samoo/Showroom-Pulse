...
class AppColors {
  ...
  static const Color lightGradientDark =
      Color(0xFF1a5276); // KPI gradient start
  static const Color lightGradientLight = Color(0xFF2980b9); // KPI gradient end

  // Background Colors (Light)
  static const Color lightBackground =
      Color(0xFFF3F4F6); // Grey 100 (Off-white background)
  static const Color lightSurface =
      Color(0xFFFFFFFF); // Pure White (Cards, Sidebar)
  static const Color lightFormBgStart =
      Color(0xFFE3F2FD); // Form gradient start
  ...
  static const Color lightTextPrimary =
      Color(0xFF111827); // Grey 900 (High contrast)
  ...
  static const Color lightBorder =
      Color(0xFFD1D5DB); // Grey 300 (Visible border)
