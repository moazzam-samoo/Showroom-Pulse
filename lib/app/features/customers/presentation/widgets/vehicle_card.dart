                        ...
                        if (!bike.isCustomerPapersDelivered) ...[
                          ...
                          Container(
                            ...
                            child: const Row(
                              ...
                              children: [
                                Icon(LucideIcons.fileWarning, size: 13, color: Colors.white),
                                SizedBox(width: 4),
                                Text(
                                  'Papers Pending',
                                  style: TextStyle(
                        ...
                        if (bike.isCustomerPapersDelivered) ...[
                          ...
                          Container(
                            ...
                            child: const Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(LucideIcons.fileCheck, size: 13, color: Colors.white),
                                SizedBox(width: 4),
                                Text(
                                  'Papers Collected',
                                  style: TextStyle(
