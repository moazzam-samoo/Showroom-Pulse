...
class _SettingsViewState extends State<SettingsView> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: const EdgeInsets.fromLTRB(
                          AppSpacing.lg, AppSpacing.lg, 0, AppSpacing.lg),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildCategoryItem(controller, 'Financials',
                              LucideIcons.percent, isDark),
                          _buildCategoryItem(controller, 'Inventory',
                              LucideIcons.package, isDark),
                          _buildCategoryItem(controller, 'Database',
                              LucideIcons.database, isDark),
                          _buildCategoryItem(
                              controller, 'Profile', LucideIcons.user, isDark),
                          _buildCategoryItem(controller, 'General',
                              LucideIcons.settings, isDark),
                          const Spacer(),
                          // ─── Footer / Credits ───
                          Padding(
              ...
              child: CoachMarkOverlay(
                targets: [
                  CoachMarkTarget(
                    ...
                    description:
                        'Switch between Financials, Database, Profile, and General settings.',
                  ...
                  CoachMarkTarget(
                    ...
                    description:
                        'Set the default percentage markup pre-filled when creating installment sales.',
                    position: CoachMarkPosition.bottom,
                    onBeforeTarget: () async {
                      Get.find<SettingsController>()
                          .changeCategory('Financials');
                    },
                  ),
                  CoachMarkTarget(
                    ...
                    description:
                        'Enable/disable automatic penalty for overdue installment payments and set the percentage.',
                    position: CoachMarkPosition.bottom,
                  ),
                  CoachMarkTarget(
                    ...
                    title: 'Bike Brands',
                    description:
                        'Manage your list of motorcycle brands. These appear as dropdown options when adding new bikes.',
                    position: CoachMarkPosition.bottom,
                    onBeforeTarget: () async {
                      Get.find<SettingsController>()
                  ...
                  CoachMarkTarget(
                    ...
                    title: 'Bike Models',
                    description:
                        'Manage your list of motorcycle models. These also appear as dropdown suggestions.',
                    position: CoachMarkPosition.bottom,
                  ),
                  CoachMarkTarget(
                    ...
                    title: 'Export Data',
                    description:
                        'Export your entire database (bikes, sales, customers) as a backup file.',
                    position: CoachMarkPosition.bottom,
                    onBeforeTarget: () async {
                  ...
                  CoachMarkTarget(
                    ...
                    title: 'Owner Profile',
                    description:
                        'Upload your profile picture that appears on the dashboard greeting.',
                    position: CoachMarkPosition.bottom,
                    onBeforeTarget: () async {
                  ...
                  CoachMarkTarget(
                    ...
                    title: 'Owner Name',
                    description:
                        'Set your name to personalize the dashboard welcome message.',
                    position: CoachMarkPosition.bottom,
                  ),
                  CoachMarkTarget(
                    ...
                    description:
                        'Restart the walkthrough guide anytime to re-learn all app features.',
  ...
  Widget _buildCategoryItem(
      SettingsController controller, String title, IconData icon, bool isDark) {
    return Obx(() {
